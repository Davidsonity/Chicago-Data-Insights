...
The three datasets used in the project are available on the city of Chicago's Data Portal:
...
The dataset to be analyzed is available as a .CSV (comma separated values) file. Click on the links below to download and save the datasets (.CSV files):
...
The following are the steps taken to store the data in the IBM DB2 database
- Open the Db2 console
- Open the LOAD tool
- Select / Drag the .CSV file for the first dataset
- Next create a New Table, and then follow the steps on-screen instructions to load the data. Name the new tables as follows:
...
- Use a sub-query to determine the Community Area Name with most number of crimes?# SQL-FOR-RECRUITERS
